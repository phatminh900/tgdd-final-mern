...
const stripeSecret =
  "sk_test_51Lfx82I9PlLZWXdKf9c1eHUaCMtvmZmoo3L6ytGdprtFXd3EhXtKPUg2DlZSaXFULzWbtFogAyWeWz2XV6J8U7Z700lU6BZ2V6";
const stripe = new Stripe(process.env.STRIPE_SECRET! || stripeSecret, {
